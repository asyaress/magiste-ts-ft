...
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="m-0">Research Sections</h1>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    @forelse($sections as $i => $sec)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.research-sections.destroy', $sec) }}" method="POST"
                                        ...
                                        <div class="modal fade" id="modalEditSection{{ $sec->id }}" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <form action="{{ route('admin.research-sections.update', $sec) }}" method="POST"
                                                    class="modal-content">
                                                    @csrf @method('PUT')
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Edit Research Section</h5>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center text-muted">Belum ada section riset.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
    ...
    <div class="modal fade" id="modalTambahSection" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="{{ route('admin.research-sections.store') }}" method="POST" class="modal-content">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Research Section</h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body">
