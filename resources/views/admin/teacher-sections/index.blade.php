...
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="m-0">Teacher Sections</h1>
                                    ...
                                    @forelse($sections as $i => $sec)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.teacher-sections.destroy', $sec) }}" method="POST"
                                        ...
                                        <div class="modal fade" id="modalEditSection{{ $sec->id }}" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <form action="{{ route('admin.teacher-sections.update', $sec) }}" method="POST"
                                                    class="modal-content">
                                                    @csrf @method('PUT')
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Edit Teacher Section</h5>
    ...
    <div class="modal fade" id="modalTambahSection" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="{{ route('admin.teacher-sections.store') }}" method="POST" class="modal-content">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Teacher Section</h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body">
