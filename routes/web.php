...
use App\Http\Controllers\Admin\AdmissionAnnouncementController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('/2fa/setup', [TwoFactorAuthController::class, 'storeSetup'])->name('2fa.setup.store');
        Route::get('/2fa/challenge', [TwoFactorAuthController::class, 'showChallenge'])->name('2fa.challenge');
        Route::post('/2fa/challenge', [TwoFactorAuthController::class, 'verifyChallenge'])->name('2fa.challenge.verify');

        Route::middleware('admin.2fa')->group(function () {
            Route::get('/', [DashboardController::class, 'index'])->name('dashboard');
            Route::get('/security', [SecurityController::class, 'index'])->name('security.index');
            Route::delete('/security/devices/{device}', [SecurityController::class, 'destroyDevice'])->name('security.devices.destroy');
            ...
            Route::get('/admission-announcements', [AdmissionAnnouncementController::class, 'index'])->name('admission-announcements.index');
            Route::post('/admission-announcements', [AdmissionAnnouncementController::class, 'store'])->name('admission-announcements.store');
            Route::put('/admission-announcements/{announcement}', [AdmissionAnnouncementController::class, 'update'])->name('admission-announcements.update');
            Route::delete('/admission-announcements/{announcement}', [AdmissionAnnouncementController::class, 'destroy'])->name('admission-announcements.destroy');
        });
    });
});
